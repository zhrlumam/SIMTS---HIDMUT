            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="edit-pembayaran.php">
                        ...
                        <span class="nav-link-text ms-1">Edit buku</span>
                    </a>
                </li>
                <li class="nav-item">
        ...
        <div class="album py-0">
            <div class="container">
                    ...
                    ?>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="edit_kategori.php?id_kategori=<?php echo $data['id_kategori']; ?>&aksi=edit_kategori">
                                        <button type="button" class="btn btn-sm btn-outline-secondary">Edit</button>
                                    </a>
                                    <a href="prosesbuku.php?id_kategori=<?php echo $data['id_kategori']; ?>&aksi=hapus_kategori">
                ...
                <div class="my-4 d-md-flex justify-content-md-end">
                    <form action="input_kategori.php" method="POST" enctype="multipart/form-data">

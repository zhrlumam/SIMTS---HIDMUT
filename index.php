...
<body class="g-sidenav-show bg-gray-100">
    ...
    <main>
        ...
        <div class="album py-5">
            <div class="container">
                <h4 class="text-center my-3" style="text-transform: uppercase; letter-spacing: 2.5px;">Tambah buku baru</h4>
                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-body text-center">
                                ...
                                <div class="text-center mb-3">
                                    <a href="input_buku.php"><button type="button" class="btn btn-sm btn-outline-primary">Tambah Buku</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col" id="home">
                        <div class="card border-0 shadow-sm">
                            <div class="card-body text-center">
                                ...
                                <div class="text-center mb-3">
                                    <a href="list_buku.php"><button type="button" class="btn btn-sm btn-outline-primary">Daftar Buku</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col" id="home">
                        <div class="card border-0 shadow-sm">
                            <div class="card-body text-center">
                                ...
                                <div class="text-center mb-3">
                                    <a href="list_penulis.php"><button type="button" class="btn btn-sm btn-outline-primary">Daftar Penulis</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col" id="home">
                        <div class="card border-0 shadow-sm">
                            <div class="card-body text-center">
                                ...
                                <div class="text-center mb-3">
                                    <a href="list_kategori.php"><button type="button" class="btn btn-sm btn-outline-primary">Daftar Kategori</button></a>
                                </div>
                            </div>
                        </div>
                    </div>

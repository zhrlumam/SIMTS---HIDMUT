...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <aside
        ...
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" href="dashboard-siswa.php">
                        <div
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card card-profile">
                        <img src="public/front-end/assets/img/kantormts.jpg" alt="Image placeholder"
                            class="card-img-top">
                        <div class="row justify-content-center">
                        ...
                        <?php $query = mysqli_query($koneksi, "SELECT * FROM siswa WHERE ID_SISWA = '" . $_SESSION['id'] . "'");
                        ...
                        <div class="card-body pt-0">
                            <div class="text-center mt-4">
                                ...
                                <div class="h6 font-weight-300">
                                    <i class="ni location_pin mr-2"></i><?php echo $d->NISN; ?>
                                </div>
                                <div class="h6 mt-4">
                                    <i class="ni business_briefcase-24 mr-2"></i><?php echo $d->GMAIL; ?>
                                </div>
                                <div>
                                    <i class="ni education_hat mr-2"></i>MTs hidayatul muta'allimin bugoharjo
                                </div>
                            </div>
                        </div>
                    </div>

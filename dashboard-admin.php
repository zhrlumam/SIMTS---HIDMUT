...
<body class="g-sidenav-show   bg-gray-100">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Dashboard admin</li>
                    </ol>
    ...
    <div class="row">
        <div class="col-xl-12 col-sm-6 mb-xl-2 mb-4">
            <a href="edit-pembayaran.php" class="card-link">
                <div class="card">
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Tambah Buku</p>
                                    <p class="mb-0">
                                        Silahkan Pilih
                                    </p>
                                </div>
        ...
        <div class="col-xl-12 col-sm-12 mb-xl-2 mb-4">
            <a href="edit-kegiatan.php" class="card-link">
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Tambah Kegiatan</p>
                                    <p class="mb-0">
                                        Silahkan Pilih
                                    </p>
                                </div>
        ...
        <div class="col-xl-12 col-sm-12 mb-xl-2 mb-4">
            <a href="edit-pengajar.php" class="card-link">
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Tambah Pengajar</p>
                                    <p class="mb-0">
                                        Silahkan Pilih
                                    </p>
                                </div>
        ...
        <div class="col-xl-12 col-sm-12 mb-xl-2 mb-4">
            <a href="edit-pelajaran.php" class="card-link">
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Tambah Pelajaran</p>
                                    <p class="mb-0">
                                        Silahkan Pilih
                                    </p>
                                </div>
        ...
        <div class="col-lg-12 mb-lg-0 mb-5">
            <div class="card z-index-2 h-100">
                <div class="card-header pb-0 pt-3 bg-transparent">
                    <h6 class="text-capitalize">Selamat Datang Di Sistem Informasi Mts Hidayatul Muta'allimin
                    </h6>

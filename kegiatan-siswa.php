      ...
      <div class="row">
        ...
        if (mysqli_num_rows($kegiatan) > 0) {
          while ($row = mysqli_fetch_array($kegiatan)) {
            ...
            ?>
            <div class="col-xl-6 col-sm-6 mb-xl-4 mb-4"> <!-- Added mb-xl-4 and mb-4 for bottom margin -->
              <div class="card">
                <a href="konfirmasi-kegiatan.php?id_kegiatan=<?= $id_kegiatan; ?>">
                    ...
                    <div class="row">
                      <div class="col-8">
                        <div class="numbers">
                          ...
                          <p class="mb-0">
                            MTs Hidayatul Muta'allimin Bugoharjo
                          </p>
                        </div>
                      </div>
                      <div class="col-4 text-end">
                        <div class="icon icon-shape bg-gradient-danger shadow-danger text-center rounded-circle">
                          <i class="fas fa-running text-lg opacity-10"></i>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          ?>
          <!-- Handle jika tidak ada data kegiatan -->
          <div class="col">

        ...
        <div class="album py-0">
            ...
            <h4 class="text-center" style="text-transform: uppercase; letter-spacing: 2.5px;">Daftar Penulis</h4>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo $data['penulis']; ?></td>
                                    <td>
                                    <a href="edit_penulis.php?id_penulis=<?php echo $data['id_penulis']; ?>&aksi=edit_penulis">
                                        <button type="button" class="btn btn-sm btn-outline-secondary">Edit</button>
                                    </a>
                                    <a href="prosesbuku.php?id_penulis=<?php echo $data['id_penulis']; ?>&aksi=hapus_penulis">
                ...
                <div class="my-4 d-md-flex justify-content-md-end">
                    <form action="input_penulis.php" method="POST" enctype="multipart/form-data">
